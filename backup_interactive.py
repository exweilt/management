...
from utils import fmt_dollars as d, fmt_bold as b, fmt_highlight as h
...
if __name__ == "__main__":
    ...
    put_cursor_at(width - max_row_visible_width, 4)
    print(string_buys, end="")
    
    put_cursor_at(width - max_row_visible_width, 5)
    ...
    put_cursor_at(2, 6)
    print(f"{b("God")} has {d(513)} {RAW_STRING*1} {PRODUCT_STRING*1} {FACTORY_STRING*2}\033[90m1\033[0m")
